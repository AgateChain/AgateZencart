...
class agate extends base
{
  ...
  function install()
  {
    ...
    $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values('Enable Agate Module', 'MODULE_PAYMENT_AGATE_STATUS', 'False', 'Enable the Agate bitcoin plugin?', '6', '0', 'zen_cfg_select_option(array(\'True\', \'False\'), ', now())");
